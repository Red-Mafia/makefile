...
ua = random.choice([
    ...
    ua_galaxys10,
    ua_lenovo])
logo = "\n\x1b[1;93m'########::'####::::'###::::'########:\n  ##.... ##:. ##::::'## ##:::..... ##::\n\x1b[1;91m  ##:::: ##:: ##:::'##:. ##:::::: ##:::\n\x1b[1;93m  ########::: ##::'##:::. ##:::: ##::::\n\x1b[1;92m  ##.. ##:::: ##:: #########::: ##:::::\n\x1b[1;91m  ##::. ##::: ##:: ##.... ##:: ##::::::\n\x1b[1;93m  ##:::. ##:'####: ##:::: ##: ########:\x1b[1;91m ------------------------------------------\n\x1b[0;91m\x1b[1;43m   RED-MAFIA      MAKE FILE :)                 \x1b[0m\n-----------------------------------------------\n\x1b[0;91m \x1a OWNERS : RED-MAFIA ~ RIAZKHAN \n\x1b[0;97m \x1a Github : RED-MAFIA\n\x1b[0;91m \x1a Note   : Use Only Kiwi Browser Token"
...
def login():
    ...
    try:
        ...
        print '%s[%s*%s]%s WelCome To RED-MAFIA %s %s' % (B, P, B, P, H, xwx['name'].lower())
...
def menu():
    ...
    print '\x1b[1;91mExample: /sdcard/RIAZ.txt'
    print ''
